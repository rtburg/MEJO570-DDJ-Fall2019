...
Well... When we set the color argumen to "School" that gave us hundreds of colors that R wants to print in the legend. Let's get rid of that legend so we can see the shapes... 
